...
dag_fc_rental_photos = DAG(
    "dag_fc_rental_photos",
...
# Creating first task
start_task = DummyOperator(task_id="start_task", dag=dag_fc_rental_photos)

producer_task = PythonOperator(
    task_id="load_db_queue_task", python_callable=load_db_queue, dag=dag_fc_rental_photos
)

# Creating last task
end_task = DummyOperator(task_id="end_task", dag=dag_fc_rental_photos)
