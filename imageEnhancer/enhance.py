...
def enhance(queue_id):
    ...
    parser.add_argument('-i', '--input', type=str, default='/app/imageInput/enhance', help='Input image or folder')
    parser.add_argument(
        '-n',
        '--model_name',
        type=str,
    ...
    parser.add_argument('-o', '--output', type=str, default='/app/imageOutput/enhanced', help='Output folder')
    parser.add_argument(
        '-dn',
        '--denoise_strength',
        type=float,
